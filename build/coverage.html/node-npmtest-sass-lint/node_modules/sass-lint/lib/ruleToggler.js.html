...
<div class="header high">
    ...
    <h2>
        ...
        Statements: <span class="metric">93.9% <small>(77 / 82)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">78.26% <small>(36 / 46)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">95% <small>(19 / 20)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">93.9% <small>(77 / 82)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1468</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">6438</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1468</span>
<span class="cline-any cline-no">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">8148</span>
<span class="cline-any cline-yes">8140</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">8</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">16</span>
...
var addEnable = function (toggledRules, rules, line, column) {
  rules.map(function (rule) {
    toggledRules.ruleEnable[rule] = toggledRules.ruleEnable[rule] || <span class="branch-1 cbranch-no" title="branch not covered" >[];</span>
...
var sortRange = function (toggleRangeA, toggleRangeB) {
  ...
  <span class="missing-if-branch" title="else path not taken" >E</span>if (aCol &gt; bCol) {
    return 1;
  }
...
var isBeforeOrSame = function (x, y, x2, y2) {
  return x &lt; x2 || (x === x2 &amp;&amp; <span class="branch-2 cbranch-no" title="branch not covered" >y &lt; y2)</span>;
};
&nbsp;
/**
...
module.exports.getToggledRules = function (ast) {
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!ast.traverseByTypes) {
<span class="cstat-no" title="statement not covered" >    return toggledRules;</span>
  ...
  ast.traverseByTypes(['multilineComment', 'singlelineComment'], function (comment, i, parent) {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!tokens.length) {
...
module.exports.isResultEnabled = function (toggledRules) {
  return function (ruleResult) {
    ...
    var line = ruleResult.line || <span class="branch-1 cbranch-no" title="branch not covered" >1;</span>
    var column = ruleResult.column || <span class="branch-1 cbranch-no" title="branch not covered" >1;</span>
...
<span class="cstat-no" title="statement not covered" >        return isBeforeOrSame(line, column, toggleRange[1], toggleRange[2])</span>
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!isGloballyEnabled) {

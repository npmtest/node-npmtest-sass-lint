...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-sass-lint/node_modules/sass-lint/lib/rules/space-around-operator.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header high">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-sass-lint/node_modules/sass-lint/lib/rules/space-around-operator.js</span></h1>
    <h2>
        
        Statements: <span class="metric">93.18% <small>(82 / 88)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">87.5% <small>(119 / 136)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">100% <small>(12 / 12)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">93.18% <small>(82 / 88)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-sass-lint/node_modules/sass-lint/lib/rules/</a> &#187; space-around-operator.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-yes">1964</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-yes">19134</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">18458</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">15918</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">15096</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
  <span class="missing-if-branch" title="else path not taken" >E</span>if (node.content === '&gt;') {
    return '&gt;=';
  }
...
&nbsp;
    ...
    //   propery: 2 / -16;
    // }
    <span class="missing-if-branch" title="if path not taken" >I</span>if (doublePrevious &amp;&amp; doublePrevious.is('operator')) {
...
&nbsp;
    ...
    //   property: calc(100% / 2);
    // }
    <span class="missing-if-branch" title="else path not taken" >E</span>if (previous &amp;&amp; next) {
...
&nbsp;
    ...
    //   unicode-range: U+26;
    // }
    <span class="missing-if-branch" title="if path not taken" >I</span>if (previous &amp;&amp; previous.is('ident') &amp;&amp; <span class="branch-2 cbranch-no" title="branch not covered" >previous.content === 'U')</span> {
<span class="cstat-no" title="statement not covered" >      return true;</span>
    }
  }
&nbsp;
...
&nbsp;
      <span class="missing-if-branch" title="else path not taken" >E</span>if (keyword.contains('ident')) {
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (isUnicode(operator, previous)) {
<span class="cstat-no" title="statement not covered" >    return true;</span>
  }
&nbsp;
...
&nbsp;
    ...
    if (node.content === '=' &amp;&amp; previous) {
      <span class="missing-if-branch" title="else path not taken" >E</span>if (previous.content === '&lt;' || previous.content === '&gt;') {
        return false;
      }
    }
&nbsp;
    ...
    if ((node.content === '&lt;' || node.content === '&gt;') &amp;&amp; next) {
      if (next.content === '=') {
        ...
        next = parent.content[i + 2] || <span class="branch-1 cbranch-no" title="branch not covered" >false;</span>
      }
    }
&nbsp;
    //////////////////////////
...
&nbsp;
      <span class="missing-if-branch" title="else path not taken" >E</span>if (parser.options.include) {
        if (

...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-sass-lint/node_modules/sass-lint/lib/rules/empty-line-between-blocks.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header high">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-sass-lint/node_modules/sass-lint/lib/rules/empty-line-between-blocks.js</span></h1>
    <h2>
        
        Statements: <span class="metric">95.77% <small>(68 / 71)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">87.01% <small>(67 / 77)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">100% <small>(5 / 5)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">95.77% <small>(68 / 71)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-sass-lint/node_modules/sass-lint/lib/rules/</a> &#187; empty-line-between-blocks.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-yes">3450</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">3450</span>
<span class="cline-any cline-yes">3320</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">3320</span>
<span class="cline-any cline-yes">3124</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">2498</span>
<span class="cline-any cline-yes">2498</span>
<span class="cline-any cline-yes">822</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-yes">7246</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">7246</span>
<span class="cline-any cline-yes">7004</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">7004</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">5724</span>
<span class="cline-any cline-yes">3784</span>
<span class="cline-any cline-yes">3476</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">3784</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1940</span>
...
<span class="cline-any cline-yes">1806</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1806</span>
<span class="cline-any cline-yes">1502</span>
...
&nbsp;
      <span class="missing-if-branch" title="else path not taken" >E</span>if (previous.type === 'space') {
...
&nbsp;
        if (space) {
          ...
          else <span class="missing-if-branch" title="if path not taken" >I</span>if (!parser.options.include &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >space.space)</span> {
<span class="cstat-no" title="statement not covered" >            result = helpers.addUnique(result, {</span>
      ...
      else <span class="missing-if-branch" title="else path not taken" >E</span>if (syntax === 'sass') {
        // Reset the counter for each ruleset
        counter = 0;
&nbsp;
        <span class="missing-if-branch" title="else path not taken" >E</span>if (node.is('ruleset')) {
&nbsp;
          node.forEach('block', function (block, i, parent) {
            var previous;
&nbsp;
            // Capture the previous node
            <span class="missing-if-branch" title="else path not taken" >E</span>if (parent.content[i - 1]) {
              previous = parent.content[i - 1];
            }
            else {
              // Else set the block to act as the previous node
<span class="cstat-no" title="statement not covered" >              previous = block;</span>
            }
&nbsp;
            // If it's a new line, lets go back up to the selector
            <span class="missing-if-branch" title="else path not taken" >E</span>if (previous.is('space') &amp;&amp; helpers.hasEOL(previous.content)) {

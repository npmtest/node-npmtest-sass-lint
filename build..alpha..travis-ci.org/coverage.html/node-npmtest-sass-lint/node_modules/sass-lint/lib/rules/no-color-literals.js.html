...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-sass-lint/node_modules/sass-lint/lib/rules/no-color-literals.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-sass-lint/node_modules/sass-lint/lib/rules/no-color-literals.js</span></h1>
    <h2>
        
        Statements: <span class="metric">79.17% <small>(38 / 48)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">66.67% <small>(46 / 69)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">83.33% <small>(10 / 12)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">79.17% <small>(38 / 48)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-sass-lint/node_modules/sass-lint/lib/rules/</a> &#187; no-color-literals.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">8746</span>
<span class="cline-any cline-no">&nbsp;</span>
<span class="cline-any cline-no">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">8746</span>
<span class="cline-any cline-yes">5480</span>
<span class="cline-any cline-yes">11416</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">11416</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">10408</span>
...
<span class="cline-any cline-yes">622</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">3492</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">9738</span>
<span class="cline-any cline-no">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-no">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
 ...
 */
var checkNextIsOperator = <span class="fstat-no" title="function not covered" >function (parent, i) {</span>
<span class="cstat-no" title="statement not covered" >  var next = parent.content[i + 1] &amp;&amp; parent.content[i + 1].type === 'operator' &amp;&amp; parent.content[i + 1].content === ':';</span>
<span class="cstat-no" title="statement not covered" >  var spacedNext = parent.content[i + 2] &amp;&amp; parent.content[i + 2].type === 'operator' &amp;&amp; parent.content[i + 2].content === ':';</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  return next || spacedNext;</span>
};
&nbsp;
/**
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (parser.options['allow-rgba'] &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >validColorFunctions.indexOf('rgba') !== -1)</span> {
<span class="cstat-no" title="statement not covered" >      validColorFunctions.splice(validColorFunctions.indexOf('rgba'), 1);</span>
    }
&nbsp;
...
&nbsp;
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if (node.is('variable') &amp;&amp; !parser.options['allow-variable-identifiers']) {
<span class="cstat-no" title="statement not covered" >        if (cssColors.indexOf(node.content[0].content) !== -1) {</span>
...
<span class="branch-1 cbranch-no" title="branch not covered" >              funcType === 'rgba' </span>&amp;&amp;
<span class="branch-2 cbranch-no" title="branch not covered" >              valElem.content[1].content[0].type !== 'variable' </span>&amp;&amp;
<span class="branch-3 cbranch-no" title="branch not covered" >              declarationType !== 'variable'</span>
            ) {
<span class="cstat-no" title="statement not covered" >              result = helpers.addUnique(result, {</span>
                'ruleId': parser.rule.name,
                'line': valElem.start.line,
...
&nbsp;
          ...
          else <span class="missing-if-branch" title="if path not taken" >I</span>if (valElem.type === 'parentheses' &amp;&amp; !parser.options['allow-map-identifiers']) {
<span class="cstat-no" title="statement not covered" >            valElem.traverse(<span class="fstat-no" title="function not covered" >function (mapVals, idx, mapValsParent) {</span></span>

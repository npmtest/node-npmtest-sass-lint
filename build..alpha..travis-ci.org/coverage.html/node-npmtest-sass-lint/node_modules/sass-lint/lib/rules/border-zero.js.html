...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-sass-lint/node_modules/sass-lint/lib/rules/border-zero.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header high">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-sass-lint/node_modules/sass-lint/lib/rules/border-zero.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-sass-lint/node_modules/sass-lint/lib/rules/</a> &#187; border-zero.js</div>
</div>
<div class="body">
...
module.exports = {
  ...
  'detect': function (ast, parser) {
    ...
    var convention = allowedConventions.indexOf(userConvention) !== -1
      ? userConvention
      : <span class="branch-1 cbranch-no" title="branch not covered" >allowedConventions[0];</span>
            ...
            if (node.type === 'number' || node.type === 'ident') {
              if (node.content === '0' || node.content === 'none') {
                if (convention !== node.content) {
                  <span class="missing-if-branch" title="if path not taken" >I</span>if (invalidConvention) {
<span class="cstat-no" title="statement not covered" >                    invalidConvention = false;</span>

...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-sass-lint/node_modules/sass-lint/lib/rules/single-line-per-selector.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header high">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-sass-lint/node_modules/sass-lint/lib/rules/single-line-per-selector.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-sass-lint/node_modules/sass-lint/lib/rules/</a> &#187; single-line-per-selector.js</div>
</div>
<div class="body">
...
var checkLineForSelector = function (ruleset, index) {
  ...
  <span class="missing-if-branch" title="else path not taken" >E</span>if (ruleset.content[curIndex]) {

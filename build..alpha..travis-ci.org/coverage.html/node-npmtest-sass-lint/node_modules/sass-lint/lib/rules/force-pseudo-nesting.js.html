...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-sass-lint/node_modules/sass-lint/lib/rules/force-pseudo-nesting.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header high">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-sass-lint/node_modules/sass-lint/lib/rules/force-pseudo-nesting.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-sass-lint/node_modules/sass-lint/lib/rules/</a> &#187; force-pseudo-nesting.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-yes">1732</span>
...
var formatOutput = function (str) {
  str = kebabcase(str);
&nbsp;
  <span class="missing-if-branch" title="else path not taken" >E</span>if (str.indexOf('nth') === -1) {
    str = capitalize(str);
  }
&nbsp;
  return str;
